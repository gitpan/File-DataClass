# @(#)$Id: DataClass.pm 442 2013-04-15 20:41:39Z pjf $

package File::DataClass;

use strict;
use namespace::clean -except => 'meta';
use version; our $VERSION = qv( sprintf '0.16.%d', q$Rev: 442 $ =~ /\d+/gmx );
...
This document describes File::DataClass version 0.16.$Revision: 442 $
